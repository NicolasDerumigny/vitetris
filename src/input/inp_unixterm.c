...
int waitinput_stdin(unsigned msec) { return waitinput(STDIN_FILENO, msec); }

void init_keybd() { inputdevs_fd[0] = STDIN_FILENO; }
...
int kb_toascii(const unsigned char *key) { return ESC + 1; }
