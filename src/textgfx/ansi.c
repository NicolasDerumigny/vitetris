...
int is_outside_screen(int x, int y) {
  return x + win_x + margin_x >= term_width || y + win_y >= term_height;
}
...
void refreshscreen() { fflush(stdout); }
...
void setattr_normal() { printf("\033[m"); }

void setattr_standout() { printf("\033[7m"); }
...
void setattr_underline() { printf("\033[4m"); }
